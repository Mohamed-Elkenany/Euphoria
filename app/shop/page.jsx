...
import FilterByCategoies from "../_components/filterProducts/FilterByCategoies";
import { useDispatch, useSelector } from "react-redux";
import { redirect } from "next/navigation";
import { handleWishlist } from "../_libs/services/customWishlist";
import { wishlistFun } from "../_utitly/slices/userSlice";
function ShopPage() {
  ...
  const handleFilterByCate = (cates) => {
    ...
    if (filterProduct.length) {
      ...
      setProducts(customProducts.allProducts);
    }
  };
  ...
  useEffect(() => {
    ...
    setAllCategories(customProducts?.allProducts);
